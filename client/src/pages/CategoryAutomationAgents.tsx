...
const tools = getToolsForCategory("automation-agents");

export default function CategoryAutomationAgents() {
      ...
      <main className="flex-1 pt-16">
        ...
        <div className="border-b border-white/[0.05] bg-[#020104]">
          <div className="container py-4">
            <div className="flex items-center gap-2 text-sm">
              ...
              <ChevronRight className="w-4 h-4 text-gray-600" />
              <span className="text-white font-medium">AI Automation & Agents</span>
            </div>
          </div>
        </div>
        ...
        <section className="container py-12 border-b border-white/[0.05]">
          ...
          <div className="max-w-3xl">
            <h1 className="text-4xl font-bold text-white mb-4">AI Automation & Agents</h1>
            <p className="text-lg text-gray-400 leading-relaxed">
              Autonomous AI agents that execute tasks, automate workflows, and deliver results without constant supervision.
              These multimodal platforms combine reasoning, code execution, and tool integration to work independently.
            </p>
          </div>
        </section>
