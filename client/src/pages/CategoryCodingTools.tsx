...
const tools = getToolsForCategory("coding-tools");
        ...
        <section className="container py-12 border-b border-white/[0.05]">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              AI-powered developer tools that accept natural language input and produce executable code output.
              These multimodal platforms help developers write, debug, and understand code more efficiently.
            </p>
          </div>
        </section>
