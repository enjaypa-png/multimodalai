...
import { getToolsForCategory, toKebabCase, getSupportedModalities } from "../../../shared/multimodalTools";

// Get multimodal-qualified tools for this category
const tools = getToolsForCategory("data-analytics");

export default function CategoryDataAnalytics() {
      ...
      <main className="flex-1 pt-16">
        ...
        <div className="border-b border-white/[0.05] bg-[#020104]">
          <div className="container py-4">
            <div className="flex items-center gap-2 text-sm">
              ...
              <ChevronRight className="w-4 h-4 text-gray-600" />
              <span className="text-white font-medium">AI Data, Analytics & Research</span>
            </div>
          </div>
        </div>
        ...
        <section className="container py-12 border-b border-white/[0.05]">
          ...
          <div className="max-w-3xl">
            <h1 className="text-4xl font-bold text-white mb-4">AI Data, Analytics & Research</h1>
            <p className="text-lg text-gray-400 leading-relaxed">
              AI-powered analytics platforms that process vast amounts of data to generate insights, predictions, and actionable intelligence.
              From sports betting analytics to research assistants, these tools combine data processing with advanced reasoning capabilities.
            </p>
          </div>
        </section>
