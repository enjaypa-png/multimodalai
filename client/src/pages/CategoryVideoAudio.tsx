...
const tools = getToolsForCategory("video-audio");
        ...
        <section className="container py-12 border-b border-white/[0.05]">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Multimodal AI tools for video generation, editing, and audio synthesis involving two or more modalities.
              These platforms help creators produce professional video and audio content efficiently.
            </p>
          </div>
        </section>
