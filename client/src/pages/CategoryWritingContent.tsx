...
const tools = getToolsForCategory("writing-content");
        ...
        <section className="container py-12 border-b border-white/[0.05]">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Multimodal AI tools that support text generation along with other modalities.
              These platforms help content creators, marketers, and writers produce high-quality content efficiently.
            </p>
          </div>
        </section>
